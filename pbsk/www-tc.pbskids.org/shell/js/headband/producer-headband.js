...
(function( require, define, factory ){
  ...
  document.getElementsByTagName("html")[0].className += document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1") ? " svg" : " no-svg";
        ...
        if( !_hideExternalLinks ){
          ...
          for( var i = 0; i < messages.length ; i++ ){
            ...
            var __parentsMessage = $(
              "<div  class='parents-message track'>" +
     ...
     */
      ...
      **************************/
      ...
      var _addSuperVisionModule = function(){
        ...
        var __CDN         = __href.match(/soup\.pbskids\.org/) ? "https://web.archive.org/web/20160303211953/http://soup-tc.pbskids.org" : __href.match(/ernie\.pbskids\.org\//) ? "https://web.archive.org/web/20160303211953/http://ernie-tc.pbskids.org" : __href.match(/^http:\/\/((?!www(\-tc)?\.).+)pbskids\.org/) ? "" : "https://web.archive.org/web/20160303211953/http://www-tc.pbskids.org";
        ...
        if( !__enabled ){
          ...
          __settings    = '<div id="code-receipt-panel" class="sync-panels">' +
                          ...
                          '</div>' +
                          '<div id="connection-confirmation-panel" class="sync-panels">' +
...
/*
     FILE ARCHIVED ON 21:19:53 Mar 03, 2016 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.017
  cdx.remote: 50.195
  LoadShardBlock: 146.431 (3)
  PetaboxLoader3.datanode: 78.058 (4)
  PetaboxLoader3.resolve: 107.929 (2)
  load_resource: 90.279
*/