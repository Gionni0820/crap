...
(function(){
  ...
  (function( require, define, factory ){
    ...
    var _LOGIN_URL  = "/go/apps/auth/prompt/";
    var _LOGOUT_URL = "/go/apps/auth/logout/";
    ...
    var _FORCE_TO_FULLSCREEN = _HAS_TOUCH || _HAS_POINTER;
    ...
    function init(){
      ...
      $(document).ready(function() {
        ...
        $('a[href="/go/apps/auth/prompt/?destination="]').removeAttr('href').attr('data-action', 'pbskids-login-sign-in');
     ...
     */
      ...
      if (username && userid){
        loginClass.user = {
          id     : userid,
          name   : username,
          avatar : 'https://web.archive.org/web/20160224183240/http://www-tc.pbskids.org/go/secretbox/images/avatars/' + ( _getCookie('pbskids.avatar') || 'trophy' ) + '.jpg',
    ...
    function initPublicMethods(){
      ...
      loginClass.displayLogin = function( queryData, url ){
        var closeButtonImageURL = "https://web.archive.org/web/20160224183240/http://www-tc.pbskids.org/includes/auth/images/close.gif";
        ...
        var resizeWindow = function(){
          ...
          var iframeContent = $("#pbskids-login-lightbox .pbskids-login-lightbox-iframe").contents();
          var contentHeight = DEFAULT_WINDOW_HEIGHT;
          var contentWidth;
          ...
          try{
            ...
            contentWidth = Math.max( iframeContent.outerWidth(true) , DEFAULT_WINDOW_WIDTH );
          }
          catch(e){ 
          ...
          //this is saying if the body is greater than 480 px do the following
          if( !_FORCE_TO_FULLSCREEN && winWidth > DEFAULT_WINDOW_WIDTH ){
            contentWindow.css({
              "width": contentWidth + "px",
              "height": contentHeight + "px",
              "margin-left": (-(contentWidth  + WINDOW_BORDER_WIDTH * 2) / 2) + "px",
              "margin-top" : (-(contentHeight + WINDOW_BORDER_WIDTH * 2) / 2) + "px",
            ...
            contentHeight = iframeContent.outerHeight(true);
            contentWindow.css({
              "height": contentHeight + "px",
              "margin-top" : (-(contentHeight + WINDOW_BORDER_WIDTH * 2) / 2) + "px",
              ...
              .append(
                 $("<iframe/>")
                  ...
                  .load(function(){
                    ...
                    pbsLoginChannel = Channel.build({ "window": this.contentWindow, "origin": "*", "scope": "pbskids-login"});
                    ...
                    if( !_FORCE_TO_FULLSCREEN ){
                      $(this).contents().ready( resizeWindow );
                    }
...
/*
     FILE ARCHIVED ON 18:32:40 Feb 24, 2016 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 6.731
  cdx.remote: 23.402
  LoadShardBlock: 255.446 (3)
  PetaboxLoader3.datanode: 367.649 (5)
  PetaboxLoader3.resolve: 287.626 (3)
  load_resource: 433.486 (2)
*/